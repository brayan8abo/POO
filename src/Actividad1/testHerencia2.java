...
public class testHerencia2{
	public static void main(String[] args) {
		...
		ProductosFrescos productoF2 = new ProductosFrescos(LocalDate.of(2024, 8, 31), 98620, LocalDate.of(2023,2,21), "Marruecos");
		ProductosFrescos productoF3 = new ProductosFrescos(LocalDate.of(2024, 11, 8), 45111, LocalDate.now(), "Colombia");
